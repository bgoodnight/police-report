...
qplot(graphdata) + 
  geom_bar() +
  scale_x_continuous(name = 'Attitude of Department', breaks = 1:5, labels=c('Overwhelmingly negative','Generally negative','Mixed','Generally positive','Overwhelmingly positive'), limits=c(0.5,5.5)) +
...
qplot(graphdata) + 
  geom_bar() +
  scale_x_continuous(name = 'Attitude of Officers', breaks = 1:5, labels=c('Greatly worsens','Somewhat worsens','No difference','Somewhat improves','Greatly improves'), limits=c(0.5,5.5)) +
  ylab("Number of Ratings") +

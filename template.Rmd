...
ggplot(graph, aes(variable, value)) +
  ...
  scale_x_discrete(name = "Question", labels=c("Does your state have a GSL in effect?","Does your state's GSL protect against arrest?","Does your state's GSL protect against charges?")) +
  coord_flip()
```
...
ggplot(graph, aes(variable, value)) +
  ...
  scale_y_continuous(labels = percent_format(), limits = c(0,1)) +
  scale_x_discrete(name = "Type of Training", labels=c("Identify and Respond to OD","Safe Handling of Opioids or Substances","Science of Addiction","Treatments for Addiction","State GSL Procedures","Treatment Services Available")) +
  coord_flip()
```

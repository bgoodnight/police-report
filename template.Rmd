...
myvars <- c('num_overdose_calls',	'narcan_carry',	'num_naloxone_administer')
...
graphlabels <- c("Responded to an overdose","Department equipped to carry narcan","Reversed an overdose in last six months")
...
ggplot(graph, aes(variable, value)) +
  ...
  scale_x_discrete(name = "Rates", labels = str_wrap(graphlabels, width = 15)) +
  coord_flip() +
  scale_fill_grey()
```
